    ...
    <div className="min-h-screen flex w-full bg-white">
      ...
      <div className="w-full lg:w-1/2 p-8 md:p-12 lg:p-24 flex flex-col justify-center relative">
        ...
        <div className="max-w-md w-full mx-auto">
          <h1 className="text-3xl font-bold text-gray-900 text-center mb-9">Create your account</h1>
          {/* <p className="text-gray-500 text-center mb-8">Let's get started with your 30 days free trial</p> */}
